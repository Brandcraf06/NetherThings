...
public class NetherEntities {
	...
	public static final EntityType<WitherPigmanEntity> WITHER_PIGMAN = register("wither_pigman", FabricEntityTypeBuilder.<WitherPigmanEntity>create(EntityCategory.MONSTER, WitherPigmanEntity::new).setImmuneToFire().size(EntityDimensions.changing(0.6F, 1.95F)));
