...
public class NetherItems {
    ...
    // foods
    public static final Item GLOWING_STEW = register("glowing_stew", new StewItem(new Item.Settings().maxCount(1).group(NetherThings.NETHER_THINGS_GROUP).food(new FoodComponent.Builder().hunger(6).saturationModifier(0.6F)
