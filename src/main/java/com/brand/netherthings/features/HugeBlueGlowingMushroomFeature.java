...
public class HugeBlueGlowingMushroomFeature extends HugeRedMushroomFeature {
	   public HugeBlueGlowingMushroomFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> function_1) {
		      super(function_1);
		   }
	  @Override
		   public boolean method_13398(IWorld iWorld_1, ChunkGenerator<? extends ChunkGeneratorConfig> chunkGenerator_1, Random random_1, BlockPos blockPos_1, DefaultFeatureConfig defaultFeatureConfig_1) {
		      ...
		      if (int_2 >= 1 && int_2 + int_1 + 1 < 256) {
		         ...
		         if (block_1 != Blocks.NETHERRACK && block_1 != Blocks.SOUL_SAND) {
		            ...
		            BlockState blockState_2 = (BlockState)OtherBlocks.BLUE_GLOWING_MUSHROOM_BLOCK.getDefaultState();

		            for(int int_7 = int_1 - 1; int_7 <= int_1; ++int_7) {
