...
public class BlazingNetherrackOreFeature extends Feature<OreFeatureConfig> {
    ...
    public boolean generate(IWorld world, ChunkGenerator<? extends ChunkGeneratorConfig> generator, Random rand, BlockPos initPos, OreFeatureConfig oreFeatureConfig_1) {
        ...
        double double_1 = (float) initPos.getX() + MathHelper.sin(randFloat_0_to_pi) * float_2;
        double double_2 = (float) initPos.getX() - MathHelper.sin(randFloat_0_to_pi) * float_2;
        double double_3 = (float) initPos.getZ() + MathHelper.cos(randFloat_0_to_pi) * float_2;
        double double_4 = (float) initPos.getZ() - MathHelper.cos(randFloat_0_to_pi) * float_2;
        double double_5 = initPos.getY() + rand.nextInt(3) - 2;
        double double_6 = initPos.getY() + rand.nextInt(3) - 2;
