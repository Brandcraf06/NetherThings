...
public class BlazingNetherrackOreFeature extends Feature<OreFeatureConfig> {

	public BlazingNetherrackOreFeature(Function<Dynamic<?>, ? extends OreFeatureConfig> function_1) {
		super(function_1);
	}

	public boolean generate(IWorld world, ChunkGenerator<? extends ChunkGeneratorConfig> generator, Random rand, BlockPos initPos, OreFeatureConfig oreFeatureConfig_1) {
		float randFloat_0_to_pi = rand.nextFloat() * 3.1415927F;
		...
		double double_1 = (double)((float)initPos.getX() + MathHelper.sin(randFloat_0_to_pi) * float_2);
		double double_2 = (double)((float)initPos.getX() - MathHelper.sin(randFloat_0_to_pi) * float_2);
		double double_3 = (double)((float)initPos.getZ() + MathHelper.cos(randFloat_0_to_pi) * float_2);
		double double_4 = (double)((float)initPos.getZ() - MathHelper.cos(randFloat_0_to_pi) * float_2);
		double double_5 = (double)(initPos.getY() + rand.nextInt(3) - 2);
		double double_6 = (double)(initPos.getY() + rand.nextInt(3) - 2);
		int int_3 = initPos.getX() - MathHelper.ceil(float_2) - int_1;
		int int_4 = initPos.getY() - 2 - int_1;
		int int_5 = initPos.getZ() - MathHelper.ceil(float_2) - int_1;
		...
		for(int int_8 = int_3; int_8 <= int_3 + int_6; ++int_8) {
			for(int int_9 = int_5; int_9 <= int_5 + int_6; ++int_9) {
				if (int_4 <= world.getTop(Heightmap.Type.OCEAN_FLOOR_WG, int_8, int_9)) {
					return this.generateVeinPart(world, rand, oreFeatureConfig_1, double_1, double_2, double_3, double_4, double_5, double_6, int_3, int_4, int_5, int_6, int_7);
				}
			}
		}
								...
								for(int int_19 = int_13; int_19 <= int_16; ++int_19) {
									...
									if (double_20 * double_20 + double_21 * double_21 + double_22 * double_22 < 1.0D) {
										...
										if (!bitSet_1.get(int_20)) {
											...
											if (iWorld_1.getBlockState(blockPos$Mutable_1).getBlock() == OtherBlocks.BLAZING_NETHERRACK || oreFeatureConfig_1.target.getCondition().test(iWorld_1.getBlockState(blockPos$Mutable_1))) {
