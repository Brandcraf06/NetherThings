...
public class BlockOreIronP extends Block {
	
	
public BlockOreIronP(String name, float hardness, float resistance) {
...
public BlockOreIronP(Block.Settings block$Settings_1) {
    super(block$Settings_1);
 }

 protected int getExperienceWhenMined(Random random_1) {
	if (this == Ores.NETHER_DIAMOND_ORE) {
         return MathHelper.nextInt(random_1, 3, 7);
    } else {
       return this == Ores.NETHER_EMERALD_ORE ? MathHelper.nextInt(random_1, 3, 7) : 0;
    }
 }
