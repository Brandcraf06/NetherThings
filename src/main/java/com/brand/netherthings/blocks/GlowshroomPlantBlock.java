...
public class GlowshroomPlantBlock extends PlantBlock implements Fertilizable {
    ...
    public GlowshroomPlantBlock(Settings settings, RegistryKey<ConfiguredFeature<?, ?>> featureKey) {
        super(settings);
