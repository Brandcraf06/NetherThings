...
public class CondemnedLeavesBlock extends LeavesBlock {


	   public CondemnedLeavesBlock(String name, float hardness, float resistance) {
			super(FabricBlockSettings.of(Material.LEAVES).sounds(BlockSoundGroup.GRASS).ticksRandomly().strength(hardness, resistance).build());
