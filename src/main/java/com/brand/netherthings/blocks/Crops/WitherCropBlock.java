...
public class WitherCropBlock extends NetherCropBlock implements WitherFertilizable {
    ...
    public boolean isWitherFertilizable(BlockView world, BlockPos pos, BlockState state, boolean isClient) {
        return !this.isMature(state);
    }
