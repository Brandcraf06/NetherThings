...
public class BaseWetSpongeBlock extends Block {
    ...
    public void randomDisplayTick(BlockState blockState_1, World world_1, BlockPos blockPos_1, Random random_1) {
        ...
        if (direction_1 != Direction.UP) {
            ...
            if (!blockState_1.isOpaque() || !Block.isSideSolidFullSquare(blockState_2, world_1, blockPos_2, direction_1.getOpposite())) {
                double double_1 = blockPos_1.getX();
                double double_2 = blockPos_1.getY();
                double double_3 = blockPos_1.getZ();
