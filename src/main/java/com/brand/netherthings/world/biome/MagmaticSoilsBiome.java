...
public class MagmaticSoilsBiome extends NetherThingsBaseBiome {

	public MagmaticSoilsBiome() {
		super("magmatic_soils", NetherSurfaces.BLAZING_CONFIG, 8);
		...
		this.addFeature(GenerationStep.Feature.UNDERGROUND_DECORATION, configureFeature(NetherThingsFeatures.BLAZING_NETHERRACK_ORE, new OreFeatureConfig(OreFeatureConfig.Target.NETHERRACK, Blocks.MAGMA_BLOCK.getDefaultState(), 50), Decorator.COUNT_HEIGHTMAP_DOUBLE, new CountDecoratorConfig(15)));
