package com.brand.netherthings.content.type;
...
public class WitheredBoneMealItem extends Item {
            ...
            if (witherfertilizable.isWitherFertilizable(world, pos, blockState, world.isClient)) {
                if (world instanceof ServerWorld) {
                    if (witherfertilizable.canGrow(world, world.random, pos, blockState)) {
                        witherfertilizable.grow(world, world.random, pos, blockState);
                    }
    ...
    public static boolean useOnGround(ItemStack stack, World world, BlockPos blockPos, Direction facing) {
        return false;
    }
