...
public class NetherBlocks {
    ...
    public static final Block GREEN_GLOWSHROOM_BLOCK = register("green_glowshroom_block", new StainedGlassBlock(DyeColor.LIME, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.SLIME).luminance(15).strength(0.2f)));
    public static final Block BLUE_GLOWSHROOM_BLOCK = register("blue_glowshroom_block", new StainedGlassBlock(DyeColor.BLUE, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.SLIME).luminance(15).strength(0.2f)));
    public static final Block PURPLE_GLOWSHROOM_BLOCK = register("purple_glowshroom_block", new StainedGlassBlock(DyeColor.PURPLE, FabricBlockSettings.of(Material.WOOD).sounds(BlockSoundGroup.SLIME).luminance(15).strength(0.2f)));

    public static final Block GREEN_GLOWSHROOM = register("green_glowshroom", new GlowshroomPlantBlock(FabricBlockSettings.of(Material.PLANT, MapColor.GREEN).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS).postProcess(NetherBlocks::always), NetherWorldgenFeatures.HUGE_GREEN_GLOWSHROOM));
    public static final Block BLUE_GLOWSHROOM = register("blue_glowshroom", new GlowshroomPlantBlock(FabricBlockSettings.of(Material.PLANT, MapColor.BLUE).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS).postProcess(NetherBlocks::always), NetherWorldgenFeatures.HUGE_BLUE_GLOWSHROOM));
    public static final Block PURPLE_GLOWSHROOM = register("purple_glowshroom", new GlowshroomPlantBlock(FabricBlockSettings.of(Material.PLANT, MapColor.PURPLE).noCollision().ticksRandomly().breakInstantly().sounds(BlockSoundGroup.GRASS).postProcess(NetherBlocks::always), NetherWorldgenFeatures.HUGE_PURPLE_GLOWSHROOM));

    public static final Block LAVA_SPONGE = register("lava_sponge", new LavaSpongeBlock(FabricBlockSettings.of(Material.SPONGE).strength(0.6F).sounds(BlockSoundGroup.GRASS)));
    public static final Block WET_LAVA_SPONGE = register("wet_lava_sponge", new WetLavaSpongeBlock(FabricBlockSettings.of(Material.SPONGE).strength(0.6F).sounds(BlockSoundGroup.GRASS)));
    ...
    public static final Block GLOWING_REEDS = register("glowing_reeds", new GlowingReedsBlock(FabricBlockSettings.of(Material.PLANT).sounds(BlockSoundGroup.GLASS).ticksRandomly().noCollision().breakInstantly().luminance(7)));
