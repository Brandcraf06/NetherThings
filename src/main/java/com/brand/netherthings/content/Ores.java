...
public class Ores {
	...
	NETHER_COAL_ORE = new BlockOreWoodP("nether_coal_ore", 3.0f, 15.0f);	
    NETHER_IRON_ORE = new BlockOreStoneP("nether_iron_ore", 3.0f, 15.0f);
    NETHER_GOLD_ORE = new BlockOreIronP("nether_gold_ore", 3.0f, 15.0f);
    NETHER_REDSTONE_ORE = new BlockRedstoneOre("nether_redstone_ore", 3.0f, 15.0f);
    NETHER_LAPIS_ORE = new BlockOreStoneP("nether_lapis_ore", 3.0f, 15.0f);
